...
def main():
    ...
    if st.session_state.selected:
        ...
        if st.session_state.prediction == "Bacteria Pneumonia":
            ...
            st.markdown('##### <a href = "https://www.mayoclinic.org/diseases-conditions/pneumonia/symptoms-causes/syc-20354204#:~:text=and%20your%20lungs-,Pneumonia%20and%20your%20lungs,within%20your%20lungs%20(alveoli).">Click this link to know more 🔗</a>',unsafe_allow_html=True)
